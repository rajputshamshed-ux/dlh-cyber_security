...
# 7. Kerberos - includes msDS-SupportedEncryptionTypes
Write-Host "[*] Checking Kerberos encryption types..." -ForegroundColor Cyan

# Query msDS-SupportedEncryptionTypes from domain object
try {
    ...
    Write-Host "    msDS-SupportedEncryptionTypes: $SupportedEncTypes" -ForegroundColor Yellow
} catch {
    Write-Host "    msDS-SupportedEncryptionTypes: Not configured (default)" -ForegroundColor Yellow
}
