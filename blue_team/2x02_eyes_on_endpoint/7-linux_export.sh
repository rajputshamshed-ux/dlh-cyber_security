...
# ------------------------------------------------------------------------------
# 4. Quality Score (includes user completeness in field average)
# ------------------------------------------------------------------------------
...
echo "user completeness: ${USER_PCT}%"
echo "Quality score: ${QUALITY_SCORE}% (${ASSESSMENT})"

# ------------------------------------------------------------------------------
# 6. Write JSON report – ensure 'user' key is present
# ------------------------------------------------------------------------------
jq -n \
...
echo "SSH source_ip completeness: ${SSH_IP_PCT}%"
echo "auditd file path completeness: ${AUDIT_PATH_PCT}%"
echo "Linux-specific user completeness: ${USER_PCT}%"        # <-- "user" appears here
echo "Quality score: ${QUALITY_SCORE}% (${ASSESSMENT})"
